    ...
    return (
      <div>
        ...
        <Typography variant="body">
          ...
          With an approximate <i>land availability</i> score of <b style={{ color: scoreColor }}>{landUseScore}</b>, This area is marked <b style={{ color: scoreColor }}><LandUsability score={landUseScore} /></b> for situating flood evacuation centers.
        </Typography>
      </div>
    );
  } else return (<div></div>)
